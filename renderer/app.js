const messages = {
  zh: {
    ...
    'summary.folder': '安装目录', 'summary.tools': '安装环境', 'summary.toolsBundledWindows': '安装或复用系统 Git、Node.js、npm 和 pnpm', 'summary.toolsBundledNative': '使用系统 Node.js、npm 和 pnpm', 'summary.registry': '依赖下载', 'summary.registryFallback': '自动选择可用源（含国内镜像）', 'summary.proxy': '下载代理', 'summary.overwrite': '安装方式', 'summary.provider': '模型提供方', 'summary.url': '服务地址', 'summary.model': '模型', 'summary.reasoning': '推理强度', 'summary.port': 'Harness 端口', 'summary.candidatePort': '测试 Harness 端口', 'summary.supervisorPort': 'Supervisor 端口', 'summary.candidateSupervisorPort': '测试 Supervisor 端口',
  ...
  en: {
    ...
    'summary.folder': 'Installation folder', 'summary.tools': 'Installation environment', 'summary.toolsBundledWindows': 'Installs or reuses system Git, Node.js, npm, and pnpm', 'summary.toolsBundledNative': 'Uses system Node.js, npm, and pnpm', 'summary.registry': 'Dependency downloads', 'summary.registryFallback': 'Automatic source selection, including the mainland mirror', 'summary.proxy': 'Download proxy', 'summary.overwrite': 'Install mode', 'summary.provider': 'Model provider', 'summary.url': 'Service URL', 'summary.model': 'Model', 'summary.reasoning': 'Reasoning', 'summary.port': 'Harness port', 'summary.candidatePort': 'Test Harness port', 'summary.supervisorPort': 'Supervisor port', 'summary.candidateSupervisorPort': 'Test Supervisor port',
