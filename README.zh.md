...
Desktop 0.2.0-rc.3是`@sparkelf/dsh-plus@0.1.0-rc.22`对应的可安装桌面端。请从配套GitHub Release下载对应平台安装包：
...
- 0.2.0-rc.3安装包是未签名prerelease artifact；Windows SmartScreen或Linux桌面安全策略可能要求用户显式确认。
