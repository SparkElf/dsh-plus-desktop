...
test('pins the Desktop installer to registry Plus rc.25 and official DSH 0.1.5-rc.1', () => {
  assert.equal(OFFICIAL_REPOSITORY, 'https://github.com/deepseek-ai/deepseek-harness.git')
  assert.equal(OFFICIAL_SOURCE_REVISION, '183f08e9c6dde7e36cd2318eaee70b0da08fb35e')
  assert.equal(PLUS_DISTRIBUTION, '@sparkelf/dsh-plus@0.1.0-rc.25')
