...
Desktop 0.2.0-rc.7 is the installable companion for `@sparkelf/dsh-plus@0.1.0-rc.24`. Download the platform installer from the matching GitHub Release:
